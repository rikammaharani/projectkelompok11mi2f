        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="{{ route('biodataMahasiswa', $id) }}">Biodata Mahasiswa</a></li>
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="card card-primary card-outline">
              <form role="form" action="{{ route('updateBiodataMahasiswa', $mahasiswa->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <div class="custom-file">
                      <input type="file" class="custom-file-input" name="photo" id="customFile" value="{{ Auth::user()->photo }}">
                ...
                <div class="card-footer">
                  ...
                  <a href="{{ route('biodataMahasiswa', $id) }}" class="btn btn-default">Cancel</a>
                </div>
              </form>
            </div>
          </div>
