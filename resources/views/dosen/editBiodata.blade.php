        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="{{ route('biodataDosen', $id) }}">Biodata Dosen</a></li>
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="card card-primary card-outline">
              <form role="form" action="{{ route('updateBiodataDosen', $dosen->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                ...
                <div class="card-footer">
                  ...
                  <a href="{{ route('biodataDosen', $id) }}" class="btn btn-default">Cancel</a>
                </div>
              </form>
            </div>
          </div>
